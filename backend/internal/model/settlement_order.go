...
type SettlementOrder struct {
	...
	ClientID           uint       `gorm:"index;not null;uniqueIndex:uq_order_client_request,priority:1" json:"client_id"`
	RequestNo          string     `gorm:"size:64;not null;default:'';uniqueIndex:uq_order_client_request,priority:2" json:"request_no"`
